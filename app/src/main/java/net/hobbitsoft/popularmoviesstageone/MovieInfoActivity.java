...
import net.hobbitsoft.popularmoviesstageone.databinding.ActivityMovieInfoBinding;
import net.hobbitsoft.popularmoviesstageone.movies.MovieInfo;

import static net.hobbitsoft.popularmoviesstageone.utils.DateUtils.dateToYear;
