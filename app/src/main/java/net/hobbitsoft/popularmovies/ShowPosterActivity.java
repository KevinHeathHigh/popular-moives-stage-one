...
public class ShowPosterActivity extends AppCompatActivity {
    ...
    private static final String TAG = ShowPosterActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String largeImageURL = intent != null ? intent.getStringExtra(MovieInfoActivity.LARGE_POSTER_URL) : null;
